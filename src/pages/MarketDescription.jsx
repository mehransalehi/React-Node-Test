...
import { marketDescriptionData } from '/src/assets/js/market_description_es.js';
...
const MarketDescription = () => {
    ...
    const filteredSports = useMemo(() => {
        if (!searchTerm) return marketDescriptionData;
        
        const term = searchTerm.toLowerCase();
        return marketDescriptionData.filter(sport =>
    ...
    const currentSport = useMemo(() => 
        marketDescriptionData.find(sport => sport.id === activeSport),
        [activeSport]
    );
